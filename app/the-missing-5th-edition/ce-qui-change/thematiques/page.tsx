...
export default async function Thematiques() {
  const { content, metadata }: MarkdownContent = await getMarkdownContent('the-missing-5th-edition/ce-qui-change/thematiques.md')
