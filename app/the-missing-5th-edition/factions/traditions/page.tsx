...
export default async function Traditions() {
  const { content, metadata }: MarkdownContent = await getMarkdownContent('the-missing-5th-edition/factions/traditions.md')
