...
export default async function Maraudeurs() {
  const { content, metadata }: MarkdownContent = await getMarkdownContent('the-missing-5th-edition/factions/maraudeurs.md')
