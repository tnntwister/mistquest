        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <section className="bg-secondary/30 p-6 rounded-lg">
            ...
            <div>
              ...
              <q className="italic mb-2 block">Alors c&apos;est vous dont m&apos;ont parlé Justine et Hisham… Dans quelques années, je serais curieuse d&apos;échanger quelques passes d&apos;arme avec vous, jeune seigneur. Je ne devrais peut-être pas vous le dire, mais vous avez réussi l&apos;exploit d&apos;impressionner voter maître d&apos;armes et ce n&apos;est pas donné à tout le monde, croyez-moi.</q>
          ...
          <section className="bg-secondary/30 p-6 rounded-lg">
            ...
            <div>
              ...
              <q className="italic mb-2 block">La puérilité des Maisons Royales m&apos;étonnera toujours ! L&apos;homme à la solde de Danilo Czerny vient d&apos;être déféré devant la Cour Martiale sur De Moley ! Mais à quoi pensent-ils, bon sang ? Et laisser cinq tenues de camouflage de la Seconde République à nos ennemis ? Quand les foudres du Pancréateur s&apos;abattront sur ces imbéciles…</q>
              <p className="mb-2">On frappe à la porte. Et le buste d&apos;un Ingénieur apparaît dans l&apos;encadrure.</p>
              <q className="italic mb-2 block">Eh bien, notre Guilde s&apos;est acquittée des donations promises, Commandeur. Je dois reconduire l&apos;appareil sur Bannockburn, donc mes compagnons et moi allons nous mettre en route. C&apos;est un plaisir que de…</q>
              <p className="mb-2">Maîtresse Halatine l&apos;interrompt.</p>
              <q className="italic mb-2 block">Un instant, vous. Comment avez-vous intercepté ma communication avec les Auriges ?</q>
              <p className="mb-2">L&apos;Ingénieur répond.</p>
              <q className="italic mb-2 block">Plaît-il ?</q>
              <p className="mb-2">Maîtresse Halatine insiste.</p>
              <q className="italic mb-2 block">Vous m&apos;avez bien entendu.</q>
              <p className="mb-2">L&apos;Ingénieur tente de se justifier.</p>
              <q className="italic mb-2 block">Je ne vois pas… vos insinuations sont inacceptables… je vais en référer… nous sommes…</q>
              <p className="mb-2">Maîtresse Halatine le coupe.</p>
              <q className="italic mb-2 block">Vous êtes sur le terrain de ma garnison. Celle qui protège les Mondes Connus d&apos;une menace que vos petits jouets ont été incapables d&apos;endiguer ! Je me sens une folle envie de les tester dans les conditions réelles ! C&apos;est bien les termes consacrés, n&apos;est-ce pas ? Alors, vous allez fermer la porte, poser votre petit cul sur cette chaise et m&apos;expliquer comment vous avez piraté mes communications !</q>
              <p className="mb-2">L&apos;ingénieur obtempère, l&apos;air contrit.</p>
              <q className="italic mb-2 block">Ce ne sont pas vos communications, Commandeur…</q>
              <p className="mb-2">Maîtresse Halatine l&apos;interrompt.</p>
              <q className="italic mb-2 block">Pardon ? Vous allez me dire que vous détenez les brevets…</q>
              <p className="mb-2">L&apos;Ingénieur continue.</p>
              <q className="italic mb-2 block">Non, non, non, Commandeur, ne vous méprenez pas… Nous avons été mandatés par les Auriges pour une maintenance de leur réseau de communication sur Bannockburn. Et pendant la durée de la maintenance… eh bien… l&apos;ensemble de leurs communications transitait par nos serveurs et… nous…</q>
              <p className="mb-2">La Commandeur s&apos;esclaffe soudain et rit à gorge déployée pendant quelques dizaines de secondes.</p>
              <q className="italic mb-2 block">Vous ferez pénitence, pour cet acte peu charitable.</q>
              <p className="mb-2">L&apos;Ingénieur proteste.</p>
              <q className="italic mb-2 block">Mais, je…</q>
              <p className="mb-2">Maîtresse Halatine le menace.</p>
              <q className="italic mb-2 block">Préférez-vous que je confie le choix de votre pénitence à la sœur Avestite de notre garnison ?</q>
              <p className="mb-2">L&apos;Ingénieur se soumet.</p>
              <q className="italic mb-2 block">Votre choix relèvera de la sagesse du Pancréateur, Commandeur.</q>
              <p className="mb-2">Maîtresse Halatine se calme.</p>
              <q className="italic mb-2 block">Le Pancréateur soit loué, vous voilà plus raisonnable. Nous discuterons de votre pénitence plus tard. En attendant, mettez-vous à l&apos;aise, vous et vos hommes, vous êtes nos invités pour les deux semaines à venir.</q>
              ...
              <q className="italic mb-2 block">Suivez-moi.</q>
              ...
              <q className="italic mb-2 block">C'est ici que se réunissait le cercle de Frère Berthold et de Dame Damiana. Tous deux vivaient dans une maison, non loin, dont il ne reste plus rien aujourd'hui, dit Maîtresse Halatine.</q>
              ...
              <q className="italic mb-2 block">Dame Theafana souhaitait que je vous conduise ici, si elle ne revenait pas de mission. Faites ce que vous avez à faire, je vous attends dehors.</q>
              ...
              <q className="italic mb-2 block">Eh bien, ça a été plutôt rapide, lâche-t-elle, en vous détaillant de pied en cap. Oh… pensez à faire soigner votre main à l'infirmerie. Un peu de désinfectant et un bandage feront l'affaire. Pas besoin d'une imposition des mains.</q>
          ...
          <section className="bg-primary/10 p-6 rounded-lg">
            ...
            <div>
              ...
              <q className="italic mb-2 block">Ton père me dit qu&apos;il te soupçonne d&apos;avoir encore écrit à tes anciens précepteurs. Entre lui et toi, me voilà bien loti : l&apos;un incapable d&apos;asseoir son autorité et l&apos;autre qui se comporte comme un bébé.</q>
